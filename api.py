...
def daily_report():
    ...
    start_time = datetime.now(beijing_tz).replace(hour=0, minute=0, second=0, microsecond=0).timestamp()
    end_time = datetime.now(beijing_tz).replace(hour=23, minute=59, second=59, microsecond=0).timestamp()
